...
const newL = Object.entries(locales)
	.map((s) => {
		return {
			Code: s[0],
			Name: s[1][0],
...
fs.writeFileSync('data/locales.json', JSON.stringify(newL));
fs.writeFileSync('data/countries.json', JSON.stringify(countryOptions));
